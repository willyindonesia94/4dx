        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto mt-3 sm:mt-0">
                    @if((isset($isSuperAdmin) && $isSuperAdmin) || auth()->user()->hasRole('Asman Perencanaan UP3'))
            ...
            <form id="bulkEditForm" action="{{ route('realisasi-wig.bulk-update') }}" method="POST" class="hidden">
                @csrf
                @method('PUT')
                        ...
                        <div class="bg-white px-6 pt-5 pb-6 overflow-y-auto">
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <input type="number" step="0.000001" name="angka_realisasi" x-model="editForm.angka_realisasi" required class="block w-full py-2.5 px-4 rounded-md border-slate-200 bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-sm">
                                </div>
                                <div>
