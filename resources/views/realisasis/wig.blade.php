        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm">
                    <button type="button" @click="$el.nextElementSibling.classList.toggle('hidden'); $el.querySelector('.toggle-icon').classList.toggle('rotate-90')" class="w-full flex justify-between items-start px-6 py-4 bg-gray-50 hover:bg-gray-100 transition-colors focus:outline-none text-left">
                        <div class="flex items-start">
                            <svg class="toggle-icon w-5 h-5 text-gray-500 mr-3 mt-0.5 transform transition-transform flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                            <div>
                    ...
                    <div class="hidden border-t border-gray-200 overflow-x-auto">
