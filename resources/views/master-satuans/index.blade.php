<x-app-layout>
    ...
    <div class="py-12" x-data="{ openModal: false, isEdit: false, formId: null, formName: '' }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between sm:justify-end mb-5 gap-4">
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                    ...
                    <button @click="openModal = true; isEdit = false; formName = ''; formId = null;" class="w-full sm:w-auto justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-4 sm:px-5 rounded-lg shadow flex items-center whitespace-nowrap">
                        <span class="hidden sm:inline">+ Tambah Satuan</span>
