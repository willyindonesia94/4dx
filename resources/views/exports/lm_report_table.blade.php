<table>
    <tr>
        <td colspan="20" style="font-size: 14px; font-weight: bold;">DATA LM - {{ strtoupper($bulan) }} {{ $tahun }}</td>
    </tr>
    <tr>
        <td colspan="20"></td>
    </tr>
...
<table border="1" style="border-collapse: collapse; width: 100%;">
    <thead>
        <tr>
            ...
            <th colspan="5" style="background-color: #0070C0; color: #FFFFFF; font-weight: bold; border: 1px solid #000000; text-align: center; vertical-align: middle;">KOMITMEN (SESI WIG)</th>
            <th rowspan="2" style="background-color: #002060; color: #FFFFFF; font-weight: bold; border: 1px solid #000000; text-align: center; vertical-align: middle;">TOTAL KOMITMEN</th>
        ...
        <tr>
            ...
            <th style="background-color: #0070C0; color: #FFFFFF; font-weight: bold; border: 1px solid #000000; text-align: center; vertical-align: middle;">M1</th>
            <th style="background-color: #0070C0; color: #FFFFFF; font-weight: bold; border: 1px solid #000000; text-align: center; vertical-align: middle;">M2</th>
            <th style="background-color: #0070C0; color: #FFFFFF; font-weight: bold; border: 1px solid #000000; text-align: center; vertical-align: middle;">M3</th>
            <th style="background-color: #0070C0; color: #FFFFFF; font-weight: bold; border: 1px solid #000000; text-align: center; vertical-align: middle;">M4</th>
            <th style="background-color: #0070C0; color: #FFFFFF; font-weight: bold; border: 1px solid #000000; text-align: center; vertical-align: middle;">M5</th>
        </tr>
    </thead>
    <tbody>
        @php $no = 1; @endphp
        @forelse($data as $row)
            ...
            <tr style="{{ $bgRow }}">
                ...
                <td style="border: 1px solid #000000; text-align: right; vertical-align: middle; {{ $bgRow }}">{{ is_numeric($row['k1']) ? number_format($row['k1'], 2) : $row['k1'] }}</td>
                <td style="border: 1px solid #000000; text-align: right; vertical-align: middle; {{ $bgRow }}">{{ is_numeric($row['k2']) ? number_format($row['k2'], 2) : $row['k2'] }}</td>
                <td style="border: 1px solid #000000; text-align: right; vertical-align: middle; {{ $bgRow }}">{{ is_numeric($row['k3']) ? number_format($row['k3'], 2) : $row['k3'] }}</td>
                <td style="border: 1px solid #000000; text-align: right; vertical-align: middle; {{ $bgRow }}">{{ is_numeric($row['k4']) ? number_format($row['k4'], 2) : $row['k4'] }}</td>
                <td style="border: 1px solid #000000; text-align: right; vertical-align: middle; {{ $bgRow }}">{{ is_numeric($row['k5']) ? number_format($row['k5'], 2) : $row['k5'] }}</td>
                <td style="border: 1px solid #000000; text-align: right; vertical-align: middle; font-weight: bold; background-color: #DEEBF7; {{ $bgRow }}">{{ is_numeric($row['total_komitmen']) ? number_format($row['total_komitmen'], 2) : $row['total_komitmen'] }}</td>
        ...
        @empty
            <tr>
                <td colspan="20" style="border: 1px solid #000000; text-align: center; font-style: italic; padding: 12px;">Tidak ada data LM untuk periode dan lingkup Bidang/Unit ini.</td>
            </tr>
        @endforelse
    </tbody>
</table>
